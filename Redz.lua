...
Dark = {
	["Color Hub 1"] = ColorSequence.new({
		ColorSequenceKeypoint.new(0.00, Color3.fromRGB(30, 40, 70)),
		ColorSequenceKeypoint.new(0.50, Color3.fromRGB(40, 55, 90)),
		ColorSequenceKeypoint.new(1.00, Color3.fromRGB(30, 40, 70))
	}),
	["Color Hub 2"] = Color3.fromRGB(40, 50, 85),
	["Color Stroke"] = Color3.fromRGB(60, 80, 120),
	["Color Theme"] = Color3.fromRGB(120, 200, 255), 
	["Color Text"] = Color3.fromRGB(230, 240, 255),
	["Color Dark Text"] = Color3.fromRGB(170, 190, 220)
},
Purple = {
	["Color Hub 1"] = ColorSequence.new({
		ColorSequenceKeypoint.new(0.00, Color3.fromRGB(25, 20, 45)),    
		ColorSequenceKeypoint.new(0.50, Color3.fromRGB(35, 30, 60)),
		ColorSequenceKeypoint.new(1.00, Color3.fromRGB(25, 20, 45))
	}),
	["Color Hub 2"] = Color3.fromRGB(30, 25, 55),
	["Color Stroke"] = Color3.fromRGB(50, 45, 85),
	["Color Theme"] = Color3.fromRGB(140, 160, 255),    
	["Color Text"] = Color3.fromRGB(230, 225, 245),
	["Color Dark Text"] = Color3.fromRGB(160, 170, 200)
}
	},
	Info = {
		Version = "1.1.0"
